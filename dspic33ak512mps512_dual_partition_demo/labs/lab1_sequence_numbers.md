...
3. Open the sequence_number.c file in example0/partition1.X project.  Compare the sequence number in the code to the terminal.  Note the that the sequence number string is the last 128-bits of the partition.<br>![Figure 2](images/lab1_figure2.png)
...
2. With the terminal window selected, press the 's' key.  
...
6. Press the 's' key to update the inactive partition sequence number (partition 1 is inactive)
...
1. Compile and program the example.
2. Press the 's' key to update the inactive partition sequence number (partition 2 is inactive)
...
5. Press the 's' key to update the inactive partition sequence number (partition 2 is inactive)
...
1. Compile and program the example.
2. Press the 's' key to update the inactive partition sequence number (partition 1 is inactive)
